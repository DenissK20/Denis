...
$laima1->price=7;
$laima1->color='green';
$label1 = $app->add(['Label', $laima1->name, $laima1->color.' massive', 'detail'=>$laima1->AllPrice(0.5), 'image'=>'http://www.laima.lv/wp-content/uploads/2016/05/4750001311662_V-VER-TE-2kg-konf-300x191.jpg']);
