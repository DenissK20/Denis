...
$laima2->price=9;
$laima2->color='red';
$label2 = $app->add(['Label', $laima2->name/*.' '.($laima2->PriceCheck())*/, $laima2->color.' massive', 'detail'=>$laima2->AllPrice(2), 'image'=>'https://nuko.lv/media/catalog/product/cache/1/image/480x740/9df78eab33525d08d6e5fb8d27136e95/0/0/00855201.jpg']);

$laima3 = new Laima;
$laima3->name='Lacīši';
$laima3->price=5;
$laima3->color='teal';
$label3 = $app->add(['Label', $laima3->name/*.' '.($laima3->PriceCheck())*/, $laima3->color.' massive', 'detail'=>$laima3->AllPrice(2), 'image'=>'http://www.ekspobirojs.lv/Attachment/NomPicture/18224_1000x1000.jpg']);

$laima4 = new Laima;
$laima4->name='Serenāde';
$laima4->price=8;
$laima4->color='blue';
$label4 = $app->add(['Label', $laima4->name/*.' '.($laima4->PriceCheck())*/, $laima4->color.' massive', 'detail'=>$laima4->AllPrice(2), 'image'=>'https://www.birojs.lv/global/uploads/images/products/8-02-003.bg.jpg']);
